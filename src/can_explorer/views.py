...
from can_explorer.plotting import PlotRow
...
class PlotView:
    ...
    def add(self, can_id: int, x: Iterable, y: Iterable) -> None:
        row = PlotRow(self.tag.plot_tab, can_id, x, y)
    ...
    def update(self, can_id: int, x: Iterable, y: Iterable) -> None:
        self._row[can_id].plot.update(x, y)
...
class SettingsView:
    ...
    def set_interface_options(self, iterable: Iterable[str], default: str = "") -> None:
        dpg.configure_item(
    ...
    def set_baudrate_options(self, iterable: Iterable[str], default: str = "") -> None:
        dpg.configure_item(
